...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Pool Cage & Screen Repair Sarasota | American Screen Hero',    description: 'Professional pool cage repair, rescreening, and screen installation in Sarasota, Lakewood Ranch, and Bradenton. Free estimates, quality service, local experts.',    siteName: "American Screen Hero",    type: "website"},
  twitter: {
    card: "summary_large_image",    title: 'Pool Cage & Screen Repair Sarasota | American Screen Hero',    description: 'Professional pool cage repair, rescreening, and screen installation in Sarasota, Lakewood Ranch, and Bradenton. Free estimates, quality service, local experts.'},
};
